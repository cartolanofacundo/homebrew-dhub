class Dhub < Formula
  ...
  homepage "https://github.com/cartolanofacundo/dhub"
  version "1.0.0"
  license "MIT"

  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/cartolanofacundo/dhub/releases/download/v1.0.0/dhub-darwin-arm64"
    ...
    if Hardware::CPU.intel?
      url "https://github.com/cartolanofacundo/dhub/releases/download/v1.0.0/dhub-darwin-amd64"
